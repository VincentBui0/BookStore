This project involves a book collection that enables the user to add, edit, delete and show information on books they've read before. The user can input the book's title, 
